...
//        });
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_profile, R.id.nav_category,R.id.nav_logout)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(Converter.convertLayoutToImage(MainNewActivity.this, cart_count, R.drawable.ic_shopping_basket));
