...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.quantitydemo.setText(_quantity);
        ...
        holder.plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pQuantity >= 1) {
                    ...
                    holder.quantitydemo.setText(total_item + "");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView cardView;
        TextView offer, currency, price, quantity, attribute, addToCart, subTotal,quantitydemo;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            quantitydemo = itemView.findViewById(R.id.quantitydemo);
