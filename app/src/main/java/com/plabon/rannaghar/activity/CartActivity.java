...
import com.plabon.rannaghar.adapter.CartAdapter;
...
public class CartActivity extends BaseActivity {
    //public static final String Satya1 = "+91 9800970578";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent intent = new Intent(CartActivity.this, MainNewActivity.class);
